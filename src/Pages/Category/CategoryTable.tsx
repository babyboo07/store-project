...
import { ICateWithChildren } from "../../common/InitObject";
import { DeleteCategory, ListCategory } from "../../services/fetchDataCategory";
                        ...
                        <td className="px-6 py-4">
                          {cate.children.length > 0 &&
                            cate.children.map((child) => (
                              <span
                                key={child.id}
                                className="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full"
                              >
                                {child.name}
                              </span>
                            ))}
