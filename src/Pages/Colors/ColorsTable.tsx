...
import { deleteColor, listColor } from "../../services/fetchDataColors";
import { IColors } from "../../common/InitObject";
      ...
      <div className="flex-grow text-gray-800">
        ...
        <main className="p-6 sm:p-10 space-y-6">
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            <div className="mr-6">
              <h1 className="text-4xl font-semibold mb-2">Colors</h1>
          ...
          <div className="bg-white border rounded-lg p-5 w-1/2">
                  ...
                  {listColors.length > 0 &&
                    listColors.map((color) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{color.rgb}</td>
                        <td className="px-6 py-4 flex items-center justify-end">
                          <Link
                            to={"/colors/detail/" + color.id}
